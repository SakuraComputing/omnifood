...
<html lang="en">
    ...
    <body>
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/img/customer-1.jpg" alt="Cusomer 1 photo">Alberto Duncan</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>Order from 8 to 12</li>
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2018 by Omnifood. All right reserved.
                </p>
            </div>
        </footer>
        ...
        <script src="http://maps.google.com/maps/api/js?key=AIzaSyCxyUeSbWsAYp9PlwhOLxEWpJFF5gV73bA"></script>
